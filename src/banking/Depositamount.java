...
public class Depositamount extends javax.swing.JFrame {
    ...
    public Depositamount(double depositAmount,double newBalance) {
        initComponents();
        amountLabel.setText("R " + String.format("%.2f", depositAmount));
    ...
    private void initComponents() {
        ...
        jPanel1.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 100, 33));
